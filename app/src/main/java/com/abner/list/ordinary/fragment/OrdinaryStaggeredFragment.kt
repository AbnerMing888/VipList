 ...
 *INTRODUCE:普通的交错列表
 */
class OrdinaryStaggeredFragment : BaseFragment<LayoutListBinding>(R.layout.layout_list) {
    override fun initData() {
        //交错
        val manger = StaggeredGridLayoutManager(2, StaggeredGridLayoutManager.VERTICAL)
        //设置布局管理器
